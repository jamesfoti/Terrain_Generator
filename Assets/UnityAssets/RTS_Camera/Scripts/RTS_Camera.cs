...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private bool beginUpdating = false;
        ...
        private void Start()
        {
            ...
            m_Transform.position = new Vector3(34.00673f, 531.3238f, -434.3952f);
            m_Transform.rotation = Quaternion.Euler(new Vector3(54.015f, 0f, 0f));
        }
